<?php
include '_partials/nav/navBlog.php';
?>
		...
		<div class="row">
			<div class="col-md-9">
				<div class="single-blog">
					<article>
						<div class="post-thumb"><img class="img-responsive" src="assets/images/blog/01.jpg" alt=""></div>
						...
						<div class="post-slider">
							<div id="post-carousel" class="carousel slide" data-ride="carousel">			
								<div class="carousel-inner">
									...
									<div class="item">
										<img src="iassets/mages/blog/03.jpg" alt="">			
									</div>
